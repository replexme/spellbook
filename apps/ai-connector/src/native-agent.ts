      ...
      [
        {
          ...
          text: [
            ...
            "When the user asks to edit, fill, create, or update content in the presentation (such as filling templates, adding text boxes, or updating slides), you must PROACTIVELY execute the mutations using native_batch_edit. Do not merely describe a plan or ask for confirmation when the user gave an edit instruction. Apply the edits directly to the presentation with native_batch_edit, perform visual review with native_review, and present the completed result.",
